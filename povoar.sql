...
VALUES (016, 'Generic fish', 100, 100, 1, 1,'water', 'Generic Water Sceneario'),
       ...
       (022, 'Huuuge fish', 20, 20, 20, 5, 'water', 'Fishermen Docks'),
...
INSERT INTO NonPlayChar (NPLAYID, speed, baseDamage, magicalBaseDamage, level, hitBox, killable, dialog)
VALUES (016, 10, 10, 10, 2, 2, 1, 'bloop bloop'),
       (017, 20, 100, 100, 8, 2, 1, 'What? Just because Im a fish doesnt mean i cant talk!'),
       (018, 20, 10, 50, 5, 2, 1, 'HIAAAAARG!'),
       (019, 5, 200, 200, 10, 2, 1, 'ಠ__ಠ'),
       (020, 1000, 10, 10, 2, 2, 1, 'I AM a fish, i swear!'),
       (021, 20, null, 45, 5, 1, 1, '*crepitates*'),
       (022, 5, 1, null, 1, 3, 1, 'BLOOP'),
       (023, 5, 2, null, 2, 2, 0, 'Hello pal. Care to learn how to fish?'),
       (024, 25, 10, 35, 4, 1, 1, 'Hushhhh... Shiiaaash...'),
       (025, 15, 50, 45, 6, 3, 1, '...'),
...
INSERT INTO Object (OBJID, Name, MaxLife, CurrentLife, x, y, TPName, SCName)
VALUES (039, 'Master Sword', 100, 100, 1, 1, 'fire', 'Generic Water Sceneario'),
